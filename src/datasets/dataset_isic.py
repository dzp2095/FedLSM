...
class SkinDatasetRaw(SkinDataset):
    def __init__(self, csv_file, cfg):
        super(SkinDatasetRaw, self).__init__(csv_file, cfg)
...
if __name__ == "__main__":
    import os
    import yaml
    csv_file = os.path.abspath('/zhipeng/isic2018/data/fl/client_0/partial_train.csv')
    cfg = yaml.safe_load(open("/home/deng/project/FedOmniCls/configs/isic2018/fl_conf.yaml"))
    dataset = SkinDataset(csv_file=csv_file,cfg=cfg)
    dataset.compute_label_mask()
